...
//concertRoom.length = concertRoom.length-1;
//console.log(concertRoom);

//concertRoom.splice(4);
//console.log(concertRoom);
...
console.log(concertRoom.length);

/*
for(i = 0; i < concertRoom.length; i++){
    name = concertRoom[i].name;
    console.log(`Salut ${name}, le concert commencera d'ici deux heures !`);  
}
*/
