...
//console.log(window.scrollY); //scroll vertical de toute la page. tout en haut = 0
// Lorsque on est en haut = 0 Quand on scroll plus bas pas = 0
...
*/
    ...
    Même calcul qu'au-dessus sauf si du contenu est en train de dépasser avec overflow.
...
//    //Donne la largeur et hauteur sans tenir compte du overflow
      // ne tient pas compte des bordure
...
Même calcul qu'au-dessus, en comptant cette fois les bordures.
...
*/
    ...
    // console.log(container.offsetRight); // n'existe pas. 
    // console.log(container.offsetParent); // le parent est body
...
*/
    ...
    // console.log(window.scrollY); // même chose
